...
class Student_end_term_averages_m extends MY_Model {

	protected $_table_name = 'form3and4endterm';
	protected $_primary_key = 'recID';
	protected $_order_by = "total_points desc";
