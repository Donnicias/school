		...
		if($usertype == "Admin" || $usertype == "Teacher") {
			...
			if($classesID != 0) {
				if($usertype == "Admin") {
					...
					$this->data['subjects'] = $this->subject_m->get_subject(array("classesID" => $classesID, "teacherID" => $teacher->teacherID));
				}
			} else {
					...
					if (!empty($sectionID)) {
						...
						if(count($students)) {
							foreach ($students as $student) {
								...
								$in_student = $this->mark_m->get_order_by_mark(array("examID" => $examID,"term_name"=>$term_name,"year"=>$year, "classesID" => $classesID, "subjectID" => $subjectID, "studentID" => $studentID));
								if(!count($in_student)) {
									$array = array(
										"examID" => $examID,
										"exam" => $exam->exam,
							...
							$all_student = $this->mark_m->get_order_by_mark(array("examID" => $examID,"term_name"=>$term_name,"year"=>$year, "classesID" => $classesID, "subjectID" => $subjectID));
