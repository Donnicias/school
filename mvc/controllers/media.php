...
*/
	...
	public function view() {
		...
		$userID = $this->userID();
		$this->data['userID'] = $userID;
		$folderID = htmlentities(mysqli_real_escape_string($this->db->conn_id,$this->uri->segment(3)));
		$folder_name = htmlentities(mysqli_real_escape_string($this->db->conn_id,$this->uri->segment(4)));
