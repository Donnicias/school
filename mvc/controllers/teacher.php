...
*/
	...
	protected function rules() {
		$rules = array(
			...
			array(
				'field' => 'initials', 
				'label' => $this->lang->line("teacher_initials"), 
				'rules' => 'trim|required|xss_clean|max_length[60]'
			), 
			array(
				'field' => 'designation', 
			...
			array(
				'field' => 'subjects', 
				'label' => $this->lang->line("teacher_subjectss"),
				'rules' => 'trim|required|max_length[128]|xss_clean'
			),
			array(
				'field' => 'dob', 
		...
		if($usertype == "Admin"){
			if($_POST) {
				...
				if ($this->form_validation->run() == FALSE) {
					...
					$array['initials'] = $this->input->post("initials");
					$array['designation'] = $this->input->post("designation");
					$array['subjects'] = $this->input->post("subjects");
