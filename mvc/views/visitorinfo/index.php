        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <div class="col-sm-5">
                    <div class="box">
                        <div class="box-header bg-olive">
                            <h3 class="box-title"><i class="fa fa-camera"></i> <?=$this->lang->line('photo')?></h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div id="visitor_face" width="240" height="240" style="margin:auto;"></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            success: function(data) {
                if (data.id) {
                    ...
                    myWindow.document.body.innerHTML =
                                    "<table width='400px' style='border-width: 1px 1px 1px 1px;margin:auto; border-spacing: 0;border-collapse: collapse;" +
                                    "border-style:solid; border-color:#eee;font-family: Verdana;font-size: 8pt;clear: both;margin: 0;padding: 0;'>" +
                                    "<tr style='height: 20px;'>" +
                                    "<td align='center' valign='middle' style='font-weight: bold;font-size: 12px;color: black;background-color:" +
                                    "#D7D8D2;width: 250px;height:30px;font-size:15pt;font-family: Verdana;font-weight:bold;background-color: #eee;color:#333;'>" +
                                    "VISITOR PASS</td></tr>" +
                                    "<tr><td align='center'><br /><img style='border-radius:5px;' width='150' height='150' src='" + print_image + "'/><br /><br />" +
                                    ...
                                    "<td align='left' stylrighte='width: 150px;font-weight:bold;'>Representing &nbsp;&nbsp;&nbsp;&nbsp;</td>" +
                ...
                success: function(data) {
                    if (data) {
                        ...
                        myWindow.document.body.innerHTML =
                                        ...
                                        "border-style: ridge;border-color:#eee;margin:auto; font-family: Verdana;font-size: 8pt;clear: both;margin: 0;padding: 0;'>" +
                                        "<tr style='height: 20px;'>" +
                                        "<td align='center' valign='middle' style='font-weight: bold;font-size: 12px;color: black;background-color:" +
                                        "#D7D8D2;width: 250px;height:30px;font-size:15pt;font-family: Verdana;font-weight:bold;background-color: #000000;color:#ffffff;'>" +
                                        "VISITOR PASS</td></tr>" +
                                        "<tr><td align='center'><br /><img width='150' height='150' src='"+image_path+"uploads/visitor/" + data.photo + "'/><br /><br />" +
                                        "<table border='0' style='font-size: 8pt;font-family: Verdana;' " +
                                        "width='200px' bgcolor='#ffffff' >" +
                                        "<tr style='height: 20px;'>" +
                                        "<td align='left' style='width: 150px;font-weight:bold;'>ID &nbsp;&nbsp;&nbsp;&nbsp;</td>" +
