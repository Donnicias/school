                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                   ...
                   <?php 
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="doa" name="doa" value="<?=set_value('doa', date("d-m-Y", strtotime($student->doa)))?>" >
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="former_primary" name="former_primary" value="<?=set_value('former_primary', $student->former_primary)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="kcpe_year" name="kcpe_year" value="<?=set_value('kcpe_year', $student->kcpe_year)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="kcpe_mark" name="kcpe_mark" value="<?=set_value('kcpe_mark', $student->kcpe_mark)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="kcpe_index" name="kcpe_index" value="<?=set_value('kcpe_index', $student->kcpe_index)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="parent_status" name="parent_status" value="<?=set_value('parent_status', $student->parent_status)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="health" name="health" value="<?=set_value('health', $student->health)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
