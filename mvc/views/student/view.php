    ...
    <div id="printablediv">
        <section class="panel">
            ...
            <div class="panel-body profile-view-dis">
                ...
                <h1 class="page-header text-center"><strong><?=$this->lang->line("personal_information")?></strong></h1>
                    ...
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("student_kcpe_year")?> </span>: <?=$student->kcpe_year?></p>
                    </div>
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("student_kcpe_mark")?> </span>: <?=$student->kcpe_mark.'/500'?></p>
                    </div>
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("student_kcpe_index")?> </span>: <?=$student->kcpe_index?></p>
                    </div>
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("student_former_primary")?> </span>: <?=$student->former_primary?></p>
                    </div>
                    ...
                    <?php } ?>
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("student_health")?> </span>: <?=$student->health?></p>
                    </div>
                </div>
                </div>
                ...
                <div class="well well-lg">
                <div class="row well well-lg">
                <h1 class="page-header text-center"><strong><?=$this->lang->line("parents_information")?></strong></h1>
                    <div class="profile-view-tab">
                    ...
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("student_parent_status")?> </span>: <?=$student->parent_status?></p>
                    </div>
                    <?php if($usertype == "Admin") { ?>
                    <div class="profile-view-tab">
