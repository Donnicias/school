  ...
  <body >
    ...
    if ($classID==13 || $classID==14) {
      foreach ($transcriptss as $transcripts) {
        $sgrades = $this->grade_m->get_grade(array("classesID"=>$classID,"subjectID"=>$transcripts->si));
      echo "<tr>";
...
echo "</table>";
      ...
      <br/><br/><br/><br/></b>
      <p style="text-align:center;"><i>*This is not a report form  but a summary of the student's score on indicated exam.</i></p><br/><br/>
    </div>
  </body>
<?php } ?>
</html>