        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?=base_url("transcripts/stream/$sectionID/$classID/$examID")?>"><?=$this->lang->line('filter')?></a></li>
                    <li class="active"><?=$section.' Transcripts'?></li>
                </ol>
            </div>
        </div>
    </div>
    ...
    foreach($student as $student) {
            ...
            <br/><br/>
                ...
                <span class="text-center">
                    ...
                    <p><?=$this->lang->line("student_classes")." ".$section?></p>
                    ...
                    <div id="hide-table">
                        <?php
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td colspan=\"3\" >";
                                        echo "<span><b>Total Points:</b> ".$student->tp."</span> <span> &nbsp  &nbsp  &nbsp&nbsp  &nbsp  &nbsp<b>Mean Grade:</b> ".$student->grade."</span> <span>  &nbsp  &nbsp &nbsp  &nbsp  &nbsp &nbsp <b>Class Position:</b> ".$i.'/'.$totalstudents;
                                    echo "</span></td>";
                                echo "</tr>";
								echo "</tbody>";
                    echo "</table>";
                    ...
                    <div id="hide-table">
                        <?php
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td colspan=\"3\" >";
                                        echo "<span><b>Total Marks:</b> ".$totalmarks."</span> <span> &nbsp  &nbsp  &nbsp&nbsp  &nbsp  &nbsp<b>Mean Grade:</b> ".$sgrade."</span> <span>  &nbsp  &nbsp &nbsp  &nbsp  &nbsp &nbsp <b>Class Position:</b> ".$i.'/'.$totalstudents;
                                    echo "</span></td>";
                                echo "</tr>";
								echo "</tbody>";
                    echo "</table>";
