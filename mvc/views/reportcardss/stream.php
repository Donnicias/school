...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?=base_url("reportcardss/filter")?>"><?=$this->lang->line('filter')?></a></li>
            ...
            <div class="col-sm-12">
                ...
                ?>
                    <h5 class="page-header">
                        <a href="<?php echo base_url('reportcardss/index') ?>">
                ...
                <div class="col-sm-6 col-sm-offset-3 list-group text-center">
                    ...
                    <br/>
                       <a href="<?=base_url("reportcardss/streamtranscripts/$sectionID/$classID/$examID")?>" class=""><button type="button" class="btn btn-default active btn-sm"><i class="fa fa-file-pdf-o" style="background-color:#500000;color:white;font-size:18px;"></i> Print All Report Cards</button></a> 
                </div> <!-- col-sm-6 --> 
                        ...
                        <thead>
                            <tr>
                                ...
                                if ($classID==13 || $classID==14) {
                                    ...
                                    ?>
                                    <th class="col-sm-2"><?=$this->lang->line('reportcardss_tm')?></th>
                                    <th class="col-sm-2"><?=$this->lang->line('reportcardss_grade')?></th>
                                    <?php
                                }
                                ?>
                                            ...
                                            <td data-title="<?=$this->lang->line('action')?>">
                                                <?php 
                                                    if($usertype == "Admin" || $usertype == "Teacher") {
                                                        ...
                                                        ?>
                                                        <a href="<?=base_url("reportcardss/view1/$classID/$examID/$student->studentID/$i/$student->tp/$totalstudents")?>" class=""><button type="button" class="btn btn-default active btn-sm"><i class="fa fa-file-pdf-o" style="background-color:#500000;color:white;"></i></button></a> 
                                                        <?php
                                                    }
                                            ...
                                            <td data-title="<?=$this->lang->line('action')?>">
                                                ...
                                                $totalmarks=round($student->stotal,0);
                                                    if($usertype == "Admin" || $usertype == "Teacher") {
                                                        //echo btn_view('transcripts/view/'.$student->studentID."/".$set, $this->lang->line('view'));
                                                        ?>
                                                       <a href="<?=base_url("reportcardss/view1/$classID/$examID/$student->studentID/$i/$totalmarks/$totalstudents")?>" class=""><button type="button" class="btn btn-default active btn-sm"><i class="fa fa-file-pdf-o" style="background-color:#500000;color:white;font-size:18px;"></i></button></a> 
                                                        <?php
                                                    }
