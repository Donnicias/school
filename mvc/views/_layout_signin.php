...
<head>
    ...
    <link href="<?php echo base_url('assets/inilabs/sign-in.css'); ?>" rel="stylesheet"  type="text/css">
    <link href="<?php echo base_url('assets/inilabs/responsive.css'); ?>" rel="stylesheet"  type="text/css">
</head>

<body class="white-bg-login">

    <div class="col-md-4 col-md-offset-4 marg" style="margin-top:10px;">
        <?php
            if(count($siteinfos->photo)) {
                echo "<center><img class='img-responsive img-rounded' width='60px' height='60px' src=".base_url('uploads/images/'.$siteinfos->photo)." /></center>";
            }
        ?>
        <center class="site-info"><h4><?php echo $siteinfos->sname; ?></h4></center>
    </div>
