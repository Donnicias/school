                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <?php } ?>
                                <?php if($usertype == "Admin" || $usertype == "Librarian") { ?>
                                <th class="col-sm-1"><?=$this->lang->line('book_isbn')?></th>
                                <?php } ?>
                                <th class="col-sm-1"><?=$this->lang->line('book_rack_no')?></th>
                                <th class="col-sm-1"><?=$this->lang->line('book_shelf_no')?></th>
                        ...
                        <tbody>
                            <?php if(count($books)) {$i = 1; foreach($books as $book) { ?>
                                <tr>
                                    ...
                                    <?php if($usertype == "Admin" || $usertype == "Librarian") { ?>
                                    <td data-title="<?=$this->lang->line('book_isbn')?>">
                                        <?php echo $book->ISBN; ?>
                                    </td>
                                    <?php } ?>
                                    ...
                                    <td data-title="<?=$this->lang->line('book_shelf_no')?>">
                                        <?php echo $book->shelf; ?>
                                    </td>
                                    ...
                                    <td data-title="<?=$this->lang->line('book_status')?>">
                                        <?php 
                                            ...
                                            }else if($book->status == 99){
                                                echo "<button class='btn btn-info btn-xs'>" . $this->lang->line('book_availability1') . "</button>";
                                            } else {
                                    ...
                                    <?php 
                                        if($book->status == 99){
                                            echo btn_found('book/found/'.$book->bookID, $this->lang->line('found'));
                                             echo btn_delete('book/delete/'.$book->bookID, $this->lang->line('delete'));
                                        }else{
                                    ?>
                                        <?php echo btn_edit('book/edit/'.$book->bookID, $this->lang->line('edit')); ?>
                                        <?php echo btn_lost('book/lost/'.$book->bookID, $this->lang->line('lost')); ?>
