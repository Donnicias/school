                ...
                <form class="form-horizontal" role="form" method="post">
                   <?php 
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="isbn" name="isbn" value="<?=set_value('isbn', $book->ISBN)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <?php 
                        if(form_error('shelf')) 
                            ...
                            echo "<div class='form-group' >";
                    ?>
                        <label for="shelf" class="col-sm-2 control-label">
                            <?=$this->lang->line("book_shelf_no")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="shelf" name="shelf" value="<?=set_value('shelf', $book->shelf)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
