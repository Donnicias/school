                        ...
                        <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                                <div id="all" class="tab-pane active">
                                    ...
                                    echo $class['classes'].' / '.$exam['exam'].' Exam Results';
                                    ?></h3></b>
                                        <table id="#example1_wrapper" class="table table-striped table-bordered table-hover dataTable no-footer table-condensed small">
                                            ...
                                            <tbody>
                                                <?php 
                                                    ...
                                                    <?php
                                                       ...
                                                       <?php }
                                                            ...
                                                            echo "</td>";
                                                            echo "<td data-title='".$this->lang->line('mark_avg')."'>";
                                                             $grades11=$this->grade_m->get_grade(array("classesID"=>1,"subjectID"=>1));
                                                                ...
                                                                if(count($grades11)) {
                                                                    if (sizeof($xandy)>0) {
                                                                        ...
                                                                        foreach ($grades11 as $grde) {
                                                                                if($grde->gradefrom <= $sccore && $grde->gradeupto >= $sccore) {
                                                                                        echo $grde->grade;
																						$mss+=$grde->point;
																						if($grde->grade==="A"){
																							$as++;
                                                ...
                                                <?php }else{
													$subjectcount=$this->ranking_m->get_total_subject_count($student->roll,$examID,$classesID);
                                                            ...
                                                            foreach ($subjectcount as $keyvalue) {
                                                                if($keyvalue->sno ==7){
                                                                            ...
                                                                            $gradepoints=round($points/7,0);
                                                                             $grades3=$this->grade_m->get_grade(array("classesID"=>001,"subjectID"=>001));
                                                                            if(count($grades3)) {
                                                                                foreach ($grades3 as $grade) {
                                                                                    if($grade->point <= $gradepoints && $grade->point >= $gradepoints) {
                                                                                        $grade=$grade->grade;
                                                                                        //echo $grade->grade;
																						$array1= array(
                                                                        ...
                                                                        if ($sciences_count==2 && $humanities_count==2) {
                                                                            ...
                                                                            if(count($grades3)) {
                                                                                foreach ($grades3 as $grade) {
                                                                                    if($grade->point <= $option1pointss && $grade->point >= $option1pointss) {
																						$array= array(
																						"roll"=>$student->studentID,
																						"examID"=>$examID,
                                                                                        "classesID"=>$classesID,
                                                                            ...
                                                                            if(count($grades3)) {
                                                                                foreach ($grades3 as $grade) {
                                                                                    if($grade->point <= $option2pointss && $grade->point >= $option2pointss) {
                                                                                        //echo $grade->grade;
                                                    ...
                                                    foreach ($subjects as $subject ) {
                                                       ?>
                                                        <td data-title="<?=$this->lang->line('ranking_subject_totals');?>"><strong><i>
                                                            <?php 
                                                             $sub_total=$this->ranking_m->get_subject_total($examID,$subject->subjectID,$classesID);
                                                ...
                                                <tr>
                                                    <td colspan="5" class="text-right"><strong>Subject Mean Scores</strong></td>
                                                    <?php
                                                    foreach ($subjects as $subject ) {
                                                       ?>
                                ...
                                <?php foreach ($sections as $section) {
                                    ...
                                    ?>
                                        ...
                                        <b><h3 class="text-center"><?php 
                                        $exam = $this->db->select('exam')->from('exam')->where('examID', $examID)->limit(1)->get()->row_array();
                                        echo $sect['section'].' / '.$exam['exam'].' Exam Results';
                                        ?></h3></b>
                                                    ...
                                                    <?php
                                                       ...
                                                       ?>
                                                            ...
                                                            echo "<td data-title='".$this->lang->line('mark_avg')."'>";
                                                                ...
                                                                $grades5=$this->grade_m->get_grade(array("classesID"=>001,"subjectID"=>001));
                                                                ...
                                                                if(count($grades5)) {
                                                                    if (sizeof($studentArray)>0){
                                                                        ...
                                                                        foreach ($grades5 as $grade) {
                                                                                if($grade->gradefrom <= $ssccore && $grade->gradeupto >= $ssccore) {
                                                                                        echo $grade->grade;
																						$smss+=$grade->point;
                                                                                        if($grade->grade==="A"){
                                                                                            $sas++;
														...
														<tr><td colspan="5" class="text-right"><strong>Subject Totals</strong></td>
															...
															foreach ($subjects as $subject ) {
															   ?>
																<td data-title="<?=$this->lang->line('ranking_subject_totals');?>"><strong><i>
																	<?php 
																	$ssub_total=$this->ranking_m->get_ssubject_total($examID,$subject->subjectID,$classesID,$section->sectionID);
														...
														<tr>
															...
															foreach ($subjects as $subject ) {
															   ?>
																<td data-title="<?=$this->lang->line('ranking_subject_averages');?>"><strong><i>
																	<?php 
																	 $ssub_avg=$this->ranking_m->get_ssubject_average($examID,$subject->subjectID,$classesID,$section->sectionID);
                                                ...
                                                ?>
													...
													<table class="table table-striped table-bordered table-hover table-condensed">
													 <h3 class="text-center page-header"><strong>Class Exam Analysis (Grades Distribution Per Stream)</strong></h3>
														...
														<?php
															...
															$rankeddata=$this->ranking_m->get_sstudents($classesID,$section->sectionID,$examID);
															//print_r($rankeddata);
													if(count($rankeddata)){
														$i = 0; 
                                                        $j = 0; 
                                                    ...
                                                    <?php
                                                        ...
                                                        foreach ($subjects as $subject ) {
                                                            $marks_s=$this->ranking_m->get_subject_mark($rankeddata->studentID,$examID,$subject->subjectID);
                                                            ...
                                                            <td data-title="<?=$this->lang->line('ranking_section');?>">
                                                                ...
                                                                foreach ($marks_s as $marks_s) {
                                                                    ...
                                                                    if (empty($marks_s->mark)) {
                                                                        echo "-";
                                                                    }else if($marks_s->mark !="X" && $marks_s->mark !="Y" && $marks_s->mark !="x" && $marks_s->mark !="y" && $marks_s->mark !="n" && $marks_s->mark !="N"){
                                                                        
																		if (is_numeric($marks_s->mark)) {
																			$s_coress=round((($marks_s->mark)/($marks_s->out_of))*100,0);
																			if(count($grades7)) {
                                                                    ...
                                                                    }else if($marks_s->mark ==="n" || $marks_s->mark ==="N"){

                                                                    }else{
                                                                        echo strtoupper($marks_s->mark);
																		array_push($form3and4a, strtoupper($marks_s->mark));
                                                                    }
                                                                }
                                                                 ?>
                                                            </td>
