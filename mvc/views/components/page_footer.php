        ...
        <!-- Polaris check boxes -->
        <script type="text/javascript" src="<?php echo base_url('assets/icheck/icheck.js'); ?>"></script>
        ...
        <?php endif ?>
    <div id="page-footer" class="bg-gray panel text-center">
    <strong><p class=""> &copy; <?php if(count($siteinfos)) { echo date("Y")."- ".$siteinfos->sname; } ?> - All rights reserved &nbsp;&nbsp;&nbsp;
    <span class=" "><a href="http://www.niftecs.com">Powered by Niftecs Company Ltd</a></span></p>
    </strong>
    </div>
    </body>
