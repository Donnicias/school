...
<header class="header" style="color:#3d9970;">
    <a id="logo-text" href="<?php echo base_url('dashboard/index'); ?>" class="logo" style="color:#3d9970;margin-left:0px;">
        <!-- Add the class icon to your logo image or logo icon to add the margining -->
        <?php
        $this->load->helper('text');
         if(count($siteinfos)) { echo word_limiter($siteinfos->sname,2); } ?>
    </a>
    <!-- Header Navbar: style can be found in header.less -->
    <nav class="navbar navbar-static-top bg-blackie" role="navigation">
            ...
            <ul class="nav navbar-nav ">
                ...
                <li class="dropdown messages-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <i class="fa fa-bell text-olive"></i>
                        <?php
                            $alCounter = 0;
                            if(count($alert) > 0) {
                                            ...
                                            echo '<li>';
                                              echo "<a href=".base_url("notice/view")."/".$alt->noticeID.">";
                                                  echo "<div class='pull-left'>" ;
                                                      echo "<img class='img-circle' src='".base_url("uploads/images/".$this->session->userdata('photo'))."'>";
                                                  echo '</div>';
                                                  echo '<h4>';
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <?=" Logged in as ".$this->lang->line($this->session->userdata("usertype"))?>

                        <img src="<?=base_url("uploads/images/".$this->session->userdata('photo'));
                        ?>" class="user-logo embed-responsive embed-responsive-4by3" alt="" />
                        <i class="caret"></i>
                    </a>
                        ...
                        <li class="user-body">
                            <div class="col-xs-4 text-center">
                                <a href="<?=base_url("profile/index")?>">
                                    <div><i class="fa fa-briefcase fa-fw"></i></div>
                            ...
                            <div class="col-xs-4 text-center">
                                <a href="<?=base_url("signin/cpassword")?>">
                                    <div><i class="fa fa-lock fa-fw"></i></div>
                                    <?=$this->lang->line("change_password")?>
                                </a>
                            </div>
                            <div class="col-xs-4 text-center">
                                <a href="<?=base_url("signin/signout")?>">
                                    <div><i class="fa fa-power-off fa-fw" ></i></div>
