            ...
            <div class="col-sm-12">
                <form action="<?=base_url('bulkimport/teacher_bulkimport');?>" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-md-1 rep-mar">
                            <a class="btn btn-success" href="<?=base_url('assets/csv/sample_teacher.csv')?>"><i class="fa fa-download"></i> <?=$this->lang->line("bulkimport_sample")?></a>
                        </div>
                    </div>
                </form>
                <form enctype="multipart/form-data" style="" action="<?=base_url('bulkimport/parent_bulkimport');?>" class="form-horizontal" role="form" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-md-1 rep-mar">
                            <a class="btn btn-success" href="<?=base_url('assets/csv/sample_parent.csv')?>"><i class="fa fa-download"></i> <?=$this->lang->line("bulkimport_sample")?></a>
                        </div>
                    </div>
                </form>
                ...
                <form enctype="multipart/form-data" style="" action="<?=base_url('bulkimport/user_bulkimport');?>" class="form-horizontal" role="form" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-md-1 rep-mar">
                            <a class="btn btn-success" href="<?=base_url('assets/csv/sample_user.csv')?>"><i class="fa fa-download"></i> <?=$this->lang->line("bulkimport_sample")?></a>
                        </div>
                    </div>
                </form>
                ...
                <form enctype="multipart/form-data" style="" action="<?=base_url('bulkimport/book_bulkimport');?>" class="form-horizontal" role="form" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-md-1 rep-mar">
                            <a class="btn btn-success" href="<?=base_url('assets/csv/sample_book.csv')?>"><i class="fa fa-download"></i> <?=$this->lang->line("bulkimport_sample")?></a>
                        </div>
                    </div>
                </form>
                <form action="<?=base_url('bulkimport/student_bulkimport');?>" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-md-1 rep-mar">
                            <a class="btn btn-success" href="<?=base_url('assets/csv/sample_student.csv')?>"><i class="fa fa-download fa-fw"></i> <?=$this->lang->line("bulkimport_sample")?></a>
                        </div>
                    </div>
                </form>
