    ...
    <div class="well">
        <div class="row">
            <div class="col-sm-6">
                ...
                <?php
                 echo btn_add_pdf('studentexamanalysis/print_preview/'.$student->studentID."/".$set, $this->lang->line('pdf_preview'))
                ?>
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb">
                    ...
                    <li><a href="<?=base_url("studentexamanalysis/index/$set")?>">Student Exam Analysis</a></li>
