            ...
            <div class="col-sm-8">
                <form class="form-horizontal" role="form" method="post">
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php
                                ...
                                foreach ($feetypes as $feetype) {
                                    $array[$feetype->feetype] = $feetype->feetype;
                                }
                    ...
                    ?>
                        ...
                        <div class="col-sm-6" id="amountfetched">
...
$('#feetype').change(function(event) {
    ...
    if(feetype === '') {
        ...
        $.ajax({
            type: 'POST',
            url: "<?=base_url('invoice/call_feetype_amount')?>",
            data: "feetype=" + feetype,
            dataType: "html",
            success: function(data) {
               $('#amountfetched').html(data);
            }
        });
    }
});
