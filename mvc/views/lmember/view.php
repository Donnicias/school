...
?>
                ...
                <div class="well">
                    <div class="row">
                        <div class="col-sm-7">
                            ...
                            <?php echo btn_sm_edit('lmember/edit/'.$lmember->studentID."/".$set, $this->lang->line('edit')) 
                            ?>
        ...
        <section class="panel">
            ...
            <div class="panel-body profile-view-dis">
                ...
                <div class="row">
                    ...
                    <div class="profile-view-tab">
                        <p><span><?=$this->lang->line("lmember_dob")?> </span>: <?=date("d M Y", strtotime($student->dob))?></p>
                    </div>
                    <div class="profile-view-tab">
                            ...
                            <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td data-title="<?=$this->lang->line('lmember_fine')?>">
                                            <?php
                                                $date = date('m-d-Y');
    ...
    <?php } else {  ?>
        <div class="col-sm-12">
        <?php echo "<h2>". $this->lang->line("lmember_message") ."</h2>"; ?>
        </div>
    <?php } ?>
