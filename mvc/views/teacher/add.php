            ...
            <div class="col-sm-8">
                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="initials_id" name="initials" value="<?=set_value('initials')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="subjects" name="subjects" value="<?=set_value('subjects')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
