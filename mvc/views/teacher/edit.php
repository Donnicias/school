        ...
        <div class="row">
            <div class="col-sm-8">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        <label for="teacher_name" class="col-sm-2 control-label">
                            <?=$this->lang->line("teacher_initials")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="initials" name="initials" value="<?=set_value('initials', $teacher->initials)?>" >
                    ...
                    <?php 
                        if(form_error('subjects')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="subjects" class="col-sm-2 control-label">
                            <?=$this->lang->line("teacher_subjects")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="subjects" name="subjects" value="<?=set_value('subjects', $teacher->subjects)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
