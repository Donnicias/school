        ...
        <div class="row">
            <div class="col-sm-8">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    <?php 
                        if(form_error('fullsubjectname')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="fullsubjectname" class="col-sm-2 control-label">
                            <?=$this->lang->line("subject_fullsubjectname")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="fullsubjectname" name="fullsubjectname" value="<?=set_value('fullsubjectname', $subject->fullsubjectname)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('fullsubjectname'); ?>
                        </span>
                    </div>
