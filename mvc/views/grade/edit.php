            ...
            <div class="col-sm-8">
                <form class="form-horizontal" role="form" method="post">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="classesID" name="classesID" value="<?=set_value('classesID', $grade->classesID)?>" readonly>
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="subjectID" name="subjectID" value="<?=set_value('subjectID', $grade->subjectID)?>" readonly>
                        </div>
                        <span class="col-sm-4 control-label">
