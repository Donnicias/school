...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_grades')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-lg-1"><?=$this->lang->line('grade_classes')?></th>
                                <th class="col-lg-1"><?=$this->lang->line('grade_subject')?></th>
                            ...
                            <?php if(count($grades)) {$i = 1; 
                                ...
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('grade_name')?>">
                                        <?php echo $grade->classes; ?>
                                    </td>
                                    <td data-title="<?=$this->lang->line('grade_name')?>">
                                        <?php echo $grade->fullsubjectname; ?>
                                    </td>
                                    <td data-title="<?=$this->lang->line('grade_name')?>">
